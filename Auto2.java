...
public class Auto2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        for(String win : driver.getWindowHandles())  //storing the no of tabs in window of type string
        {      driver.switchTo().window(win);  //for the other than main-window tab switch to that tab
        }
        ...
        //split is string method where regex(regular expression),will spilt by space giving "Token:" at index 0 & rest the token value at index 1.
        String token = tokenValue[1];  //will get the token value from index 1 into string token
        Cookie cookie = new Cookie("Token", token);  //method to add this value as cookie 
        ...
        driver.close();  //close the window of tatoc
